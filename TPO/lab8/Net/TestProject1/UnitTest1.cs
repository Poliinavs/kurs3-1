...
namespace AircompanyTests.Tests
{
    ...
    public class AirportTest
    {
        ...
        public void MyTest1()
        {
            ...
            NUnit.Framework.Assert.IsTrue(hasMilitaryTransportPlane);
        }
        ...
        {
            Airport airport = new Airport(planes);
            airport = airport.SortBy(plane => plane.MaxLoadCapacity());
            ...
            NUnit.Framework.Assert.That(nextPlaneMaxLoadCapacityIsHigherThanCurrent == true);
        }
    }
}